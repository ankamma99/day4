...
public class Task2 extends Mainclass
{
	@Test
	public void signin()
	{
		...
		getDriver().findElement(By.id("sign-in-email")).sendKeys("ankamma");
		getDriver().findElement(By.id("sign-in-password")).sendKeys("13456");
